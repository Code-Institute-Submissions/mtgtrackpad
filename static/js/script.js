...
$(document).ready(function () {
  $(".check-fields").on("click", function () {
    ...
    if ($("#first_w").val() == 2 || $("#first_w").val() == 1 && $("#first_l").val() == 0) {
            res = 'won'
     ...
     if ($("#second_w").val() == 2 || $("#second_w").val() == 1 && $("#second_l").val() == 0) {
            res2 = 'won'
    ...
    if ($("#third_w").val() == 2 || $("#third_w").val() == 1 && $("#third_l").val() == 0) {
            res3 = 'won'
    ...
    if ($("#fourth_w").val() == 2 || $("#fourth_w").val() == 1 && $("#fourth_l").val() == 0) {
            res4 = 'won'
    ...
    if ($("#fifth_w").val() == 2 || $("#fifth_w").val() == 1 && $("#fifth_l").val() == 0) {
            res5 = 'won'
    ...
    $("#eventrecordinput").val(roundswon + ' - ' + roundsdrawn + ' - ' + roundslost);
